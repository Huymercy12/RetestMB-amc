...
ResponseObject response =WS.sendRequestAndVerify(findTestObject('Object Repository/Api/IAM/Get buildings by current user'), FailureHandling.CONTINUE_ON_FAILURE)
...
ResultSet rs = Statemnet.getBuildingsByCurrentUser(username)

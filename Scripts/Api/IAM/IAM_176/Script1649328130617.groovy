...
Map maps = [('organizationId') : organizationId, ('dayOfBirth') : dayOfBirthRandom, ('gender') : gender, ('fullName') : fullNameRandom
    , ('email') : emailRandom, ('phoneNumber') : phoneNumberRandom]

ResponseObject response = WS.sendRequestAndVerify(findTestObject('Object Repository/Api/IAM/Create Organization Contact', maps), FailureHandling.STOP_ON_FAILURE)

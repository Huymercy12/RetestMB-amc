...
ResponseObject response = WS.sendRequestAndVerify(findTestObject('Object Repository/Api/IAM/Refresh token', maps), FailureHandling.STOP_ON_FAILURE)
...
WS.verifyNotMatch(WS.getElementPropertyValue(response, 'data.accessToken').toString(), GlobalVariable.accessToken, false)

WS.verifyNotMatch(WS.getElementPropertyValue(response, 'data.refreshToken').toString(), GlobalVariable.refreshToken, false)
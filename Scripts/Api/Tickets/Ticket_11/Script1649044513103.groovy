...
Map maps = [('buildingId') : buildingId, ('content') : content, ('floorId') : floorId, ('status') : status, ('note') : note]

ResponseObject response = WS.sendRequestAndVerify(findTestObject('Object Repository/Api/Tickets/Ticket Issued By Customer No Image', maps), FailureHandling.STOP_ON_FAILURE)

...
Map maps = [('buildingId') : buildingId, ('content') : content, ('floorId') : floorId
	, ('issuedUserId') : issuedUserId, ('note') : note, ('organizationId') : organizationId, ('serviceType') : serviceType]

ResponseObject response = WS.sendRequestAndVerify(findTestObject('Object Repository/Api/Tickets/Ticket Issued By Employee No Image', maps), FailureHandling.STOP_ON_FAILURE)

...
WS.callTestCase(findTestCase('Test Cases/Api/Complaints/Complaints_23-25'), [('complaintFileIds') : complaintFileIds,
	...
	('username') : username,
	('password') : password,
	('complaintIdsClassify') : complaintIdsClassify,
	('invalidReason') : invalidReason,
	('statusCodeClassify') : '200',
	('typeComplaint') : 'SPAM'])
}
...
ResponseObject response1 = WS.sendRequestAndVerify(findTestObject('Object Repository/Api/Complaints/Delete complaint', maps), FailureHandling.STOP_ON_FAILURE)

...
Map maps = [('pageIndex') : pageIndex, ('pageSize') : pageSize, ('hasPageable') : hasPageable, ('keyword') : keyword]

ResponseObject response = WS.sendRequestAndVerify(findTestObject('Object Repository/Api/Building/Search Building', maps), FailureHandling.STOP_ON_FAILURE)
